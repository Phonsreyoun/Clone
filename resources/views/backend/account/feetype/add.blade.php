        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <form novalidate id="entryForm" action="{{route('feetype.store')}}" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="number" class="form-control" name="amount" placeholder="$0.00" value=""  maxlength="255">
                                        <span class="fa fa-info form-control-feedback"></span>
