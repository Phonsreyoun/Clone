...
Route::group(
    ...
    function () {
        ...
        Route::resource('salary-template', 'SalaryTemplateController');
...
//web artisan routes
Route::get(
    '/student-attendance-file-queue-start/{code}',
    function ($code) {
        if ($code == "hr799") {
            try {
...
Route::get(
    '/employee-attendance-file-queue-start/{code}',
    function ($code) {
        if ($code == "hr799") {
            try {
